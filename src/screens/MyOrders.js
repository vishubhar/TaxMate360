...
import {
  View, Text, StyleSheet, Image, Dimensions, TextInput, TouchableOpacity, ScrollView, Modal, TouchableWithoutFeedback, Pressable
} from 'react-native';
    ...
    <View style={styles.firstRow}>
      ...
      <View style={styles.SuccessRow}>
        ...
        <Image
          ...
          source={status === 'success' ? require('../Assets/icons/tick.png') : require('../Assets/icons/cross.png')}
        />
      </View>
    </View>
...
const RadioButton = ({ label, selected, onPress }) => (
  <TouchableOpacity onPress={onPress} >
    <View style={styles.radioButtonContainer}>
      <View style={{ height: 20, width: 20, borderRadius: 10, borderWidth: 2, borderColor: '#1E74FD', alignItems: 'center', justifyContent: 'center', marginRight:5}}>
...
const MyOrders = ({ onSearch }) => {
  ...
  const ordersData = [
    { title: 'Form-16', orderId: '************', date: 'Fri, 6 March', status: 'success', buttonLabel: 'Download' },
    { title: 'Consultancy Fees', orderId: '************', date: 'Wed, 4 March', status: 'failure', buttonLabel: 'Get Details' },
    { title: 'Consultancy Fees', orderId: '************', date: 'Wed, 4 March', status: 'success', buttonLabel: 'Get Details' },
    { title: 'Form-16', orderId: '************', date: 'Fri, 6 March', status: 'failure', buttonLabel: 'Download' },
  ];
  return (
    ...
    <ScrollView style={styles.Maincontainer}>
      <View style={styles.section}>
        <View style={styles.searchbarContainer}>
          ...
          <TouchableOpacity style={styles.container2} onPress={handleFilterPress}>
            <Image
              style={{ height: 25, width: 25, marginRight: 10 }}
              source={require('../Assets/icons/setting.png')} />
            <Text style={{ fontSize: 14, fontWeight: "700", color: "black" }}>FILTER</Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              <View style={styles.buttonRow}>
                ...
                <TouchableOpacity onPress={() => setShowFilterModal(false)}><Image
                  style={{ height: 25, width: 25, marginRight: 10 }}
                  source={require('../Assets/icons/close-outline.png')} /></TouchableOpacity>
              </View>

              <View style={styles.radioGroup}>
                <View style={{ borderBottomWidth: 0.5, marginBottom: 5 }}>
                  <Text style={{ fontSize: 15, color: 'black', marginBottom: 15, fontWeight: "700" }}>Title</Text>
                  <RadioButton
                    label="Form-16"
                ...
                <View style={{ borderBottomWidth: 0.5, marginBottom: 5 }}>
                  <Text style={{ fontSize: 15, color: 'black', marginBottom: 15, fontWeight: "700" }}>Status</Text>
                  <RadioButton
                    label="Success"
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity style={styles.clearFilterButton} onPress={handleClearFilters}>
                  <Text style={{ color: '#185AF6' , fontWeight:"700"}}>Clear Filters</Text>
                </TouchableOpacity>
                <Pressable style={styles.applyFilterButton} onPress={handleApplyFilter}>
